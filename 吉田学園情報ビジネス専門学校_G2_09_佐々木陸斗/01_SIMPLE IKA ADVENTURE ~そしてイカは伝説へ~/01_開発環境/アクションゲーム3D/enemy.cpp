...
void lnitEnemy(void)
{
	...
	for (nCntEnemy = 0; nCntEnemy < MAX_Enemy; nCntEnemy++)
	{
		...
		g_Enemy[nCntEnemy].move = D3DXVECTOR3(0.0f, 0.0f, 0.0f);    //移動量の初期化
...
void UpdateEnemy(void)
{
	...
	if (g_nEnemyCounter % 430 == 0)
	{
		SetEnemy(D3DXVECTOR3(2300.0f, 230.0f, -170.0f), D3DXVECTOR3(0.0f, 0.0f, 0.0f), D3DXVECTOR3(0.0f, 0.0f, -9.0f), 0); //車1
		SetEnemy(D3DXVECTOR3(2450.0f, 230.0f, -170.0f), D3DXVECTOR3(0.0f, 0.0f, 0.0f), D3DXVECTOR3(0.0f, 0.0f, -7.0f), 1); //車1
		SetEnemy(D3DXVECTOR3(2600.0f, 230.0f, -170.0f), D3DXVECTOR3(0.0f, 0.0f, 0.0f), D3DXVECTOR3(0.0f, 0.0f, -7.0f), 0);//壁奥
		SetEnemy(D3DXVECTOR3(2750.0f, 230.0f, -170.0f), D3DXVECTOR3(0.0f, 0.0f, 0.0f), D3DXVECTOR3(0.0f, 0.0f, -9.0f), 2);//壁奥
	}
	else if (g_nEnemyCounter % 200 == 0)
	{
		SetEnemy(D3DXVECTOR3(2300.0f, 230.0f, -170.0f), D3DXVECTOR3(0.0f, 0.0f, 0.0f), D3DXVECTOR3(0.0f, 0.0f, -9.0f), 0); //車1
		SetEnemy(D3DXVECTOR3(2450.0f, 230.0f, -170.0f), D3DXVECTOR3(0.0f, 0.0f, 0.0f), D3DXVECTOR3(0.0f, 0.0f, -7.0f), 1); //車1
		SetEnemy(D3DXVECTOR3(2600.0f, 230.0f, -170.0f), D3DXVECTOR3(0.0f, 0.0f, 0.0f), D3DXVECTOR3(0.0f, 0.0f, -9.0f), 0);//壁奥
		SetEnemy(D3DXVECTOR3(2750.0f, 230.0f, -170.0f), D3DXVECTOR3(0.0f, 0.0f, 0.0f), D3DXVECTOR3(0.0f, 0.0f, -7.0f), 2);//壁奥
	}
...
void SetEnemy(D3DXVECTOR3 pos, D3DXVECTOR3 rot, D3DXVECTOR3 move, int nType)
{
	for (int nCntEnemy = 0; nCntEnemy < MAX_Enemy; nCntEnemy++)
	{
		...
		{//ブロックが使用されてない場合
			g_Enemy[nCntEnemy].pos = pos;			//位置	
			g_Enemy[nCntEnemy].rot = rot;			//向き
